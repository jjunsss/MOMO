...
| Path | Best for | Start |
|---|---|---|
| **Colab trial (Beginner)** | First-time users who want to try MOMO without touching a server. | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jjunsss/MOMO/blob/main/notebooks/MOMO_Colab.ipynb) |
| **Local/server GUI (Regular user)** | Repeated use, private recordings, long meetings, and team/shared machines. | `scripts/start-gui.sh` |
